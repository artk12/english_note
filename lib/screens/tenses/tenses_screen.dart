...
class TensesScreen extends StatelessWidget {
  ...
  Widget tenseTitle(BuildContext context , String title,Color color){
    return Row(
      children: [
        ...
        Container(margin: const EdgeInsets.symmetric(horizontal: 10),child: Text(title,style: Theme.of(context).textTheme.headline1!.copyWith(fontSize: 23,color: color),)),
        Expanded(child: Container(height: 1,color: color,)),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    List<Tense> futureTenses = tenses.where((element) => element.tense == "Future").toList();
    List<Tense> presentTenses = tenses.where((element) => element.tense == "Present").toList();
    List<Tense> pastTenses = tenses.where((element) => element.tense == "Past").toList();
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(color: Colors.blueGrey,spreadRadius: 2,blurRadius: 2)
                  ]
                ),
                child: Text(
